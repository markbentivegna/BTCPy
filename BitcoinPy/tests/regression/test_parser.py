...
class BlockchainParserTest(unittest.TestCase):
    ...
    def test_initial_block_file(self):
        blockchain_parser = BlockchainParser(
            f"{os.getcwd()}/BitcoinPy/tests/blocks", 0, 0)
    ...
    def test_segwit_block_file(self):
        blockchain_parser = BlockchainParser(
            f"{os.getcwd()}/BitcoinPy/tests/blocks", 1, 1)
    ...
    def test_mempool(self):
        blockchain_parser = BlockchainParser(
            f"{os.getcwd()}/BitcoinPy/tests/blocks", 0, 0, include_mempool=True)
    ...
    def test_all(self):
        ...
        blockchain_contents = []
        expected_output = {}
        with open(f"{os.getcwd()}/BitcoinPy/tests/regression/expected_output.json", "r") as file:
